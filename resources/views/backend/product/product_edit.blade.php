...
@section('admin')
                                            ...
                                            <select name="vendor_id"
                                                ...
                                                @foreach ($activeVendor as $vendor)
                                                    <option value="{{ $vendor->id }}"
                                                        {{ old('vendor_id', $products->vendor_id) == $vendor->id ? 'selected' : '' }}>
                                                        {{ $vendor->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('vendor_id')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('update.product.multi.image') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                                ...
                                @foreach ($multiImgs as $key => $img)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete.product.multi.image', ['id' => $img->id]) }}"
