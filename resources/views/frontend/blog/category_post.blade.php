...
<a href="blog-post-right.html" class="text-brand font-heading font-weight-bold">Read more <i
        class="fi-rs-arrow-right"></i></a>
<a href="{{ url('post/details/' . $post->id . '/' . $post->post_slug) }}"
...
<li>
    <a href="shop-grid-right.html"> <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}"
            alt="" />{{ $category->blog_category_name }}</a><span class="count">{{ count($posts) }}</span>
