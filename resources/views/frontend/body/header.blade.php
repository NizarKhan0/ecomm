                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                @auth
                                    <a href="#"><span class="ml-0 lable">Account</a>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i
                                                        class="mr-10 fi fi-rs-location-alt"></i>Order
                                                    Tracking</a>
                                            </li>
                                            <li>
                                ...
                                @else
                                    <a href="{{ route('login') }}"><span class="ml-0 label">Login</span></a>
                                    <span class="mx-2">|</span>
                                    <a href="{{ route('register') }}"><span class="ml-0 label">Register</span></a>
                                @endauth
                            ...
                            <div class="d-flex categori-dropdown-inner">
                                ...
                                <ul class="end">
                                    @foreach ($categories as $item)
                                        <li>
                                            <a href="shop-grid-right.html">
                                                <img src="{{ asset($item->category_image) }}" alt="Category" />
                                                {{ $item->category_name }}
                                            </a>
                                        </li>
                                    @endforeach
