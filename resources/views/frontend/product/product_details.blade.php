                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                            <div class="detail-gallery">
                                    ...
                                    @foreach ($multiImage as $img)
                                        <figure class="border-radius-10">
                                            @if (empty($img->photo_name))
                                                <img src="{{ asset('upload/default.jpg') }}" alt="product image" />
                                            @else
                                ...
                                <div class="slider-nav-thumbnails">
                                    @foreach ($multiImage as $img)
                                        @if (empty($img->photo_name))
                                            <div><img src="{{ asset('upload/default.jpg') }}" alt="product image" /></div>
                                        @else
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="detail-extralink mb-50">
                                    <div class="border detail-qty radius">
                                        <input type="number" name="quantity" id="dqty" class="qty-val" value="1" min="1" step="1">
                                    </div>
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    <div class="vendor-logo d-flex mb-30">
                                        <img src="{{ !empty($product->vendor->photo) ? url('upload/vendor_images/' . $product->vendor->photo) : url('upload/default.jpg') }}"
                                            alt="" />
