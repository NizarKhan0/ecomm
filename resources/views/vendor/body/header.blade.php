<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            {{-- Untuk ambil data dari controller bebas --}}
            @php
                $id = Auth::user()->id;
                $vendorData = App\Models\User::find($id);
            @endphp

            {{-- <img src="{{ !empty(Auth::user()->photo) ? url('upload/admin_images/' . $adminData->photo) : url('upload/default.jpg') }}" class="user-img"
            alt="user avatar"> --}}
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty($vendorData->photo) ? url('upload/vendor_images/' . $vendorData->photo) : url('upload/default.jpg') }}" class="user-img"
                        alt="user avatar">
